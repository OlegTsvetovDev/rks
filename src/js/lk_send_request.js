...
$(document).ready(function () {
  ...
  function openModalPersonalData() { // Модалка "Согласие на обработку персональных данных"
  ...
  function openModalRules() { // Модалка "Правила пользования интерактивным сервисом"
  ...
  var listItemInquiry = $('.list__item.inquiry'), // список классов для запроса
  ...
  var listItemRequest = $('.list__item.request'), // список классов для заявки
  ...
  function handleInquiryForm() { // переключение формы подачи запроса
  ...
  function handleRequestForm() { // переключение формы подачи заявки
